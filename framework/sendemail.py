...
class Email:
    ...
    def _attach_file(self, att_file):
        ...
        self.msg.attach(att)
        # logger('attach file {}'.format(att_file))
...
if __name__ == '__main__':
    ...
    # report = REPORT_PATH + '\\2018-01-17-13_45_45HTMLtemplate.html'
    report = r'D:\PycharmProjects\AutoTestEinvoice\test_report\2018-01-17-13_45_45HTMLtemplate.html'
    e = Email(title='百度搜素测试报告',
              message='这是今天的测试报告，请查收！',
              receiver='huhaixiang@yonyou.com;zhangxiaoxue@yonyou.com',
              server='mail.yonyou.com',
              sender='huhaixiang@yonyou.com',
              password='ufida2013%',
              path=report
              )
    e.send()